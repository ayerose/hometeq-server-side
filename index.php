...
echo "<p>".$arrayp['prodDescripShort'];   //display product descrip. as contained in the array
echo "<p><b>&pound".$arrayp['prodPrice']."</b>";   //display product Price as contained in the array
